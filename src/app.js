...
import IconDef from './icondefinitions'
...
class App extends React.Component {
  ...
  handleForward() {
    if (this.myQuery.Skip + this.myQuery.Take < this.props.total) {
      let newQ = Object.assign({}, this.myQuery, {
  ...
  componentDidMount() {
    ...
    let newQ = Object.assign({}, this.myQuery, this.props.query)
    this.myQuery = newQ
    if (extQueryText) {
        newQ = Object.assign({}, this.myQuery, {
        Text: extQueryText
      })
      this.updateQueryAndDoSearch(newQ)
    }
